...
- 사람이 무언가를 진행하는 데 방해하는 요소. 플레이어가 이 장애물을 회피하면서 게임을 진행해야함.

### 서브 컨셉 1 : 집중도

- 장애물이 자신에게 오기 때문에 어느 타이밍에 피해야 하는 지 장애물을 봐야 하기 때문에 집중해야 함.

### 서브 컨셉 2 : 몰입도

- 장애물을 피하면서 나아가야 하기 때문에 게임에 몰입하게 된다.

### 서브 컨셉 3 : 다양성

- 장애물이 하나가 아니기 때문에 플레이어는 다양한 장애물을 피해야 한다.

### 서브 컨셉 4 : 효과

- 장애물을 피하기 위해서 이동을 할 때 그냥 좌표만 바뀌는 것 보단 효과를 주어서 키가 눌려져서 이동했다는 것을 확실하게 인식하게 함.
...
(캐릭터) 캐릭터는 화면 좌측에 위치해 있으며, 장애물이 오는 것을 집중시키기 위함 그리고 간단하게 조작하기 위하여 위 아래로만 움직일 수 있게 되어 있습니다.
