...
- 1. 노말 난이도를 만든다. 노말 난이도에서는 모든 장애물의 데미지가 + 1가 된다.
- 2. 하드 난이도를 만든다. 하드 난이도에서는 모든 장애물의 속도가 2배 빨라진다.
- 3. 매드 난이도를 만든다. 매드 난이도에서는 모든 장애물의 데미지가 + 2가 된다.
- 4. 루나틱 난이도를 만든다. 루나틱 난이도에서는 모든 장애물의 데미지가 + 1가 되며 속도도 빨라진다.
- 5. 레슈 난이도를 만든다. 루나틱 난이도에서는 모든 장애물의 데미지가 + 2가 되며 속도도 빨라진다.
