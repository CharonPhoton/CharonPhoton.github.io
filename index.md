...
- ~~플레이어의 보호막 가스의 보유 수 1개 이상 보유 할 경우, 장애물에 피격될 경우, 자동으로 보호막 가스의 보유 수가 1개 줄고 라이프를 잃지 않으며, 5초 동안 무적 상태가 된다. (100%)~~
...
- ~~스테이지를 진행하면서 생성되는 장애물의 속도를 점점 더 빠르게 한다. ( 최대 1.25배 ) (100%)~~
