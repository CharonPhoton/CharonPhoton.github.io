...
- 보스1는 공격 모드에서 두 가지 공격 쿨다운이 있다. 두 공격 쿨다운은 0이 되면, Y좌표 3개 중 하나에 약화된 레슈 물질을 화면 중앙 X좌표에서 소환하는 특징이 있다.
- 보스1가 사망 시 프로세스 바는 100%이기 때문에 보스 사망 애니메이션을 보여주고 사망하게 된다.
- 보스1의 사망 애니메이션은 점차 부분부분 사라지는 모션으로 하며, 마지막에는 레슈 물질의 파괴 애니메이션을 넣는다.
